...
class Mancala:
    ...
    def update_player(self, player, pit):
        """
        Updates the individual game boards for the players based on it being Player 1's turn.
        """
        arr0 = [0]*14
